package jdbc.lesson4_2.dao;


import jdbc.lesson4_2.models.File;
import jdbc.lesson4_2.models.Storage;
...
public class FileDAO {
    ...
    public File save(File file) throws Exception {
        ...
        try (PreparedStatement prepareStatement = lesson4.dao.Jdbc.connect(true).prepareStatement(sqlRequestSaveFile)) {
    ...
    public void delete(long id) {
        try (PreparedStatement prepareStatement = lesson4.dao.Jdbc.connect(true).prepareStatement(sqlRequestDeleteFile)) {
    ...
    public File update(File file) throws Exception {
        try (PreparedStatement prepareStatement = lesson4.dao.Jdbc.connect(true).prepareStatement(sqlRequestUpdateFile)) {
    ...
    public List<File> updateList(List<File> files) throws Exception {
        ...
        long id = 0;
        try (PreparedStatement prepareStatement = lesson4.dao.Jdbc.connect(false).prepareStatement(sqlRequestUpdateFile)) {
            int res = 0;
            for (File file : files) {
            ...
            lesson4.dao.Jdbc.connect(false).commit();
            ...
            e.printStackTrace();
            lesson4.dao.Jdbc.connect(false).rollback();
            throw e;
        }
    }
    ...
    public File findById(Long id) throws Exception {
        ...
        try (PreparedStatement prepareStatement = lesson4.dao.Jdbc.connect(true).prepareStatement(sqlRequestFindByIdFile)) {
